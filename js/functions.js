 ...
 *  Example > sayHello("codeup") // returns "Hello, codeup!"
 */
 ...
 */
let helloMessage = sayHello(`Mitchell`);
 ...
 */
function applyDiscount(itemPrice, discountPercent){
    return itemPrice - (itemPrice * discountPercent);
}

let newPrice = applyDiscount(prompt(`What is the original price?`), prompt(`What is the discount percentage?`));
